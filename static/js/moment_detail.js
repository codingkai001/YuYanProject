$(document).ready(function () {
    ...
    $.ajax({
            url: "http://120.77.32.233/xinyuan/wish/get/" + id,
            type: "POST",
            xhrFields: {
                withCredentials: true
            },
            success: function (result, status, xhr) {
                if (result.code === 200) {
                    ...
                    for (var i = 0; i < result.data.comment.length; ++i) {
                        ...
                        var item = "<li class=\"am-comment\"><a href=\"\"><img src=\"http://120.77.32.233/xinyuan/img/user/" + user_id + " class=am-comment-avatar\" alt=\"\"/></a>\n" +
